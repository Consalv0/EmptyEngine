...
namespace EE
{
    class CPURenderInterface : public RenderInterface
    {
        ERenderInterface GetType() const;

        bool Initialize();

        bool CreatePresentContext( class Window* window, PresentContext& outContext );
        ...
        bool CreateShaderStage( EShaderStage stage, const void* shaderBytecode, size_t bytecodeLength, ShaderStage& outShaderStage ) const;
        ...
        EShaderFormat GetShaderFormat() const { return ShaderFormat_None; }
